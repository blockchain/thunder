 ...
 * Example Code to implement here:     https://github.com/jetty-project/embedded-jetty-websocket-examples/tree/master/native-jetty-websocket-example/src/main
 * /java/org/eclipse/jetty/demo
 */
