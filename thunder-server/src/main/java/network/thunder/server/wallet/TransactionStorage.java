        ...
        if (correct) {
            ...
            for (int i = 0; i < paymentList.size(); ++i) {
                ...
                if (p.getSecret() != null) {
                    ...
                    if (SideConstants.RUNS_ON_SERVER) {
                        inputScript = ScriptTools.getSettlementScriptSig(channel, signature1, signature2, p.getSecret(), serverIssuedTransaction, p.paymentToServer);
                    } else {
                        inputScript = ScriptTools.getSettlementScriptSig(channel, signature2, signature1, p.getSecret(), serverIssuedTransaction, p.paymentToServer);
                    }
                    /**
