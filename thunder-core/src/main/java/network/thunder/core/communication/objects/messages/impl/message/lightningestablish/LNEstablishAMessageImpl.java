 ...
 */
public class LNEstablishAMessageImpl implements LNEstablishAMessage {
    ...
    public LNEstablishAMessageImpl (byte[] pubKeyEscape, byte[] pubKeyFastEscape, byte[] secretHashFastEscape, byte[] revocationHash, long clientAmount, long
            serverAmount) {
