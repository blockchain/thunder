...
CREATE TABLE IF NOT EXISTS `lightning_channels` (
  ...
  `opening_tx_hash_server` binary(32) DEFAULT NULL,
  `opening_tx_hash_client` binary(32) DEFAULT NULL,
  `opening_secret_server` binary(20) DEFAULT NULL,
  `opening_secret_client` binary(20) DEFAULT NULL,
  `escape_tx_sig` blob,
