...
CREATE TABLE IF NOT EXISTS `channels` (
  ...
  `opening_tx_hash_server` varchar(500) DEFAULT NULL,
  `opening_tx_hash_client` varchar(500) DEFAULT NULL,
  `opening_secret_server` varchar(500) DEFAULT NULL,
  `opening_secret_client` varchar(500) DEFAULT NULL,
  `opening_tx` int(11) DEFAULT NULL,
  `escape_tx` int(11) DEFAULT NULL,
  `escape_fast_tx` int(11) DEFAULT NULL,
