...
public class Main extends Application {
    ...
    public void setupWalletKit (@Nullable DeterministicSeed seed) {
        ...
        //        bitcoin = new WalletAppKit(params, new File(System.getProperty("user.home")+"\\Documents"), APP_NAME + "-" + params.getPaymentProtocolId()
        // +CLIENTID) {
        ...
        if (params == RegTestParams.get()) {
            ...
            // As an example!
            // bitcoin.useTor();
            // bitcoin.setDiscovery(new HttpDiscovery(params, URI.create("http://localhost:8080/peers"), ECKey.fromPublicOnly(BaseEncoding.base16().decode
            // ("02cba68cfd0679d10b186288b75a59f9132b1b3e222f6332717cb8c4eb2040f940".toUpperCase()))));
        }
