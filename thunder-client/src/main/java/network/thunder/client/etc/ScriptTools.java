...
public class ScriptTools {
	...
	public static boolean checkPaymentScript (TransactionOutput output, Channel channel, KeyWrapper keyList, String R, boolean serverSide, boolean
			paymentToServer) throws Exception {
	...
	public static void checkTransaction (Transaction transaction, int inputIndex, Sha256Hash hash, long amount, String payoutAddress, int locktime) throws
			Exception {
	...
	public static Script getRefundScriptSig (Channel channel, ECDSASignature signatureClient, ECDSASignature signatureServer, boolean serverSide, boolean
			paymentToServer) throws Exception {
		ScriptBuilder builder = new ScriptBuilder();
	...
	public static Script getSettlementScriptSig (Channel channel, ECDSASignature signatureClient, ECDSASignature signatureServer, String secret, boolean
			serverSide, boolean paymentToServer) throws Exception {
		ScriptBuilder builder = new ScriptBuilder();
